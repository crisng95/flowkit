...
2. real provider UNKNOWN_REMOTE_STATE reconciliation evidence;
3. Electron credential-broker evidence;
...
Reach L6 only after executing the remaining hardening spikes.

```text
provider reconciliation proof
+ credential broker proof
+ Windows persistence/update proof
+ QA calibration
+ repair benchmark
...
Do not freeze architecture or decompose production coding tasks yet.

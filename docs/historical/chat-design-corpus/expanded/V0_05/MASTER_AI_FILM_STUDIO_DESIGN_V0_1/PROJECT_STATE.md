...
→ Static QA calibration
→ Targeted Repair benchmark
→ Performance/cost benchmark
→ independent review 43..N
```

Provider ambiguity is **architecturally resolved but only PARTIAL_PROOF** until live provider fault injection is available.

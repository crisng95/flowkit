...
**Origin:** V0.1 architecture baseline; latest subsystem decisions supersede stale sections.  
...
V0.10 correction: job state is **orthogonal**, not one giant enum.

Canonical authority: `JOB_STATE_MODEL_V0_10.md`.
...
A derived UI summary may combine these axes, but persistence keeps them separate.

# EVIDENCE_LEDGER_V0_13.md

**Purpose:** authoritative inventory of what is actually evidenced versus merely designed.
...
A gate cannot close from a lower evidence class than required by `L6_GATE_RULES_V0_13.json`.
